...
@Component({
  selector: 'app-rpt-basic-data',
  templateUrl: './rpt-basic-data.component.html',
  styleUrls: ['./rpt-basic-data.component.css']
})
export class RptBasicDataComponent {
  ...
  clearFilter() {  
    this.api.getBasicDataReport(this.filter?.dateFrom,this.filter?.dateTo,0,0,0,'All')
    .subscribe((res: any) => {
      this.rptData = res;
    })
  }
