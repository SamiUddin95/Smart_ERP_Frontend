...
@Component({
  selector: 'app-jurn-vuchr-list',
  templateUrl: './jurn-vuchr-list.component.html',
  styleUrls: ['./jurn-vuchr-list.component.css']
})
export class JurnVuchrListComponent {
  ...
  editItem(id: any) {
    this.router.navigate(['jurn-vuchr-form/' + id]);
  }

  addItem() {
    this.router.navigate(['jurn-vuchr-form']);
  }
  cancel() {
