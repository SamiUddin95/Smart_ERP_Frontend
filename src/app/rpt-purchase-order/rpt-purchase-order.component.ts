...
@Component({
  selector: 'app-rpt-purchase-order',
  templateUrl: './rpt-purchase-order.component.html',
  styleUrls: ['./rpt-purchase-order.component.css']
})
export class RptPurchaseOrderComponent {
  ...
  getData() {
    ...
    this.api.getPurchaseOrderReport(
