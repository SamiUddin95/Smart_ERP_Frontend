...
@Component({
  selector: 'app-stck-adj-list',
  templateUrl: './stck-adj-list.component.html',
  styleUrls: ['./stck-adj-list.component.css']
})
export class StckAdjListComponent {
  ...
  editItem(id: any) {
    this.router.navigate(['stck-adj-form/' + id]);
  }

  addItem() {
    this.router.navigate(['stck-adj-form']);
  }
  cancel() {
